...
const CLIENTES_CC: Array<{ displayName: string; saldoInicialCents: number; planCode: string; billingCycle: "QUINCENAL" | "MENSUAL" }> = [
  ...
  { displayName: "Posco Enc Arg",    saldoInicialCents: 0, planCode: "CORPO1_BEBIDAS",       billingCycle: "MENSUAL" },
  { displayName: "Posco Enc Kor",    saldoInicialCents: 0, planCode: "CORPO1_SNACK_BEBIDA",  billingCycle: "MENSUAL" },
